      ...
      {modalOpen && (
        ...
        >
          <div
            ...
            className="w-full max-w-lg rounded-2xl border border-[#2b3f5d] bg-[#0f1828] p-6 text-zinc-100 shadow-xl"
            onClick={(e) => e.stopPropagation()}
          >
            <h2 id="new-novel-title" className="text-lg font-semibold text-zinc-100">
              新建小说
            </h2>
            <div className="mt-4 space-y-4">
              <div>
                ...
                <input
                  ...
                  maxLength={500}
                  className="w-full rounded-lg border border-[#38506f] bg-[#0b1320] px-3 py-2 text-sm text-zinc-100 placeholder:text-zinc-500"
                  placeholder="例如：星海尽头"
                  autoFocus
                />
              </div>
              <div>
                ...
                <textarea
                  ...
                  rows={5}
                  maxLength={20000}
                  className="w-full resize-y rounded-lg border border-[#38506f] bg-[#0b1320] px-3 py-2 text-sm text-zinc-100 placeholder:text-zinc-500"
            ...
            <div className="mt-6 flex justify-end gap-2">
              <button
                ...
                onClick={closeModal}
                disabled={submitting}
                className="rounded-lg border border-[#3a4f6b] px-4 py-2 text-sm font-medium text-zinc-200 hover:border-[#4f6d95] hover:text-white"
              >
                取消
              </button>
              <button
