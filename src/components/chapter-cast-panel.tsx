        ...
        <>
          <div className="shrink-0 px-2">
            <p className="mb-1 text-[10px] font-medium text-neutral-600 dark:text-neutral-400">
              登场人物
              <span className="ml-1 font-normal text-neutral-500">（上下滑动列表，点击切换）</span>
            </p>
            <ul
              className="max-h-[min(40vh,260px)] overflow-y-auto rounded-lg border border-neutral-200 bg-white dark:border-neutral-700 dark:bg-neutral-900/50"
              role="listbox"
              aria-label="本章登场人物列表"
            >
              {files.map((f) => {
                ...
                return (
                  <li key={f.fileName} className="border-b border-neutral-100 last:border-b-0 dark:border-neutral-800">
                    ...
                    >
                      ...
                      {pres ? (
                        <span className="line-clamp-2 text-[10px] font-normal text-neutral-500 dark:text-neutral-400">
                          {pres}
                        </span>
                      ) : null}
                    </button>
