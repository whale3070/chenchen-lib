...
const ZH: ProgressStage[] = [
  {
    dateLabel: "2026 年 5 月 15 日（第四十九天）",
    title: "开发进度",
    items: [
      "现状是“只按 OpenAI chat/completions 协议转发”。现在这套是 Anthropic Provider 配置，做成双协议兼容（OpenAI/Anthropic 都能跑），这样在网页端 aiChat 直接可用。",
      "修复了隐私政策和用户服务协议的格式。",
    ],
  },
  {
    dateLabel: "2026 年 5 月 14 日（第四十八天）",
    title: "开发进度",
    items: [
      "在官网上增加了隐私政策和用户服务协议。",
  ...
  {
    dateLabel: "2026 年 5 月 13 日（第四十七天）",
    title: "开发进度",
    items: [
      "把“排版策略”从发布弹窗移出，放到 AI 写作区域单独设置。",
      "修复 AI 排版常见报错（worker 读取 .env.production 路径不对）并加更稳的回退逻辑。",
      "【bug 修复】AI 聊天导入 JSON 文件时，不再覆盖之前所有对话。",
    ],
  },
  {
    dateLabel: "2026 年 5 月 10 日（第四十四天）",
    title: "开发进度",
    items: [
      "选中喜欢句子：已实现（正文选区触发）。",
      "弹框写感想：已实现（钱包连接校验 + 字数限制）。",
      "一键看所有人划线/只看原文：已实现（Tab 切换）。",
      "【bug 修复】视频管理“关联目标章节”仅显示占位问题已修复。",
      "【bug 修复】新建小说弹窗白底白字可读性问题已修复。",
      "【bug 修复】划线后点击写感想弹框立即消失问题已修复。",
    ],
  },
  {
